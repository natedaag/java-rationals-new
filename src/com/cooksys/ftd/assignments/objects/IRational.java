...
interface IRational {
	 ...
	 */
	default IRational negate() throws IllegalArgumentException {
	...
	default IRational add(IRational that) throws IllegalArgumentException {
		...
		return construct(((this.getNumerator() * that.getDenominator()) + 
						(that.getNumerator() * getDenominator())),(getDenominator() * that.getDenominator()));
	}
	...
	default IRational div(IRational that) throws IllegalArgumentException {
		if (that == null || this.getNumerator() * that.getDenominator() == 0) {
			throw new IllegalArgumentException();
		}
		return construct((this.getNumerator() * that.getDenominator()) , 
